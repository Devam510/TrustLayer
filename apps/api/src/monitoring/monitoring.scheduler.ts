...
import { QUEUE_BALANCE_CHECK } from './queue.constants';
...
export class MonitoringScheduler implements OnApplicationBootstrap {
  ...
  constructor(
    @InjectQueue(QUEUE_BALANCE_CHECK.CRITICAL) private readonly criticalQueue: Queue,
    @InjectQueue(QUEUE_BALANCE_CHECK.STANDARD) private readonly standardQueue: Queue,
    @InjectQueue(QUEUE_BALANCE_CHECK.FREE) private readonly freeQueue: Queue,
  ) {}
